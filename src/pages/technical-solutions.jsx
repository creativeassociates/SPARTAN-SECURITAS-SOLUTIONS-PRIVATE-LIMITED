...
export function TechnicalSolutions() {
    const para = "Spartan Securitas Solutions Private Limted offers cutting-edge technical solutions designed to enhance operational efficiency and streamline processes for businesses across various sectors. Our innovative solutions include:\n" +
        "<br/> <br/> \n" +
