...
export function AutomatedParkingManagement() {
    const para = "Spartan Securitas Solutions Private Limted provides cutting-edge Automated Parking Management solutions to streamline vehicle flow and enhance parking efficiency. Our system leverages advanced technology, including sensors and GPRS integration, to automate vehicle entry, exit, and parking allocation.\n" +
        "<br/><br/>\n" +
