...
export function FireExtinguishers() {
    const para = "Spartan Securitas Solutions Private Limted offers a wide range of fire extinguishers as part of our comprehensive electronic security solutions. Our fire extinguishers are designed to meet the highest safety standards, providing quick and effective response to fire hazards across various types of facilities.\n" +
        "<br/><br/>\n" +
