export const services = [
    ...
    {
        img: "./img/security-guard.webp",
        name: "Security Guards",
        path: "/",
        services: [
            {name: "Security guards at access points to counter theft", path: "/"},
            {name: "Body Guards", path: "/"},
            {name: "Gun mans", path: "/"},
            {name:"Housekeeping professionals for sanitization and upkeep", path: "/"}
        ],
    },
    {
